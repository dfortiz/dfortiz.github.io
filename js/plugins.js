...
! function(o, t) {
    ...
    return function() {
        ...
        function m(o) {
            t || (t = o), s = u(a = o - t, n, c, f), window.scrollTo(0, s), a < f ? window.requestAnimationFrame(m) : (window.scrollTo(0, n + c), e && d && (e.setAttribute("tabindex", "-1"), e.focus()), "function" == typeof l && l(), t = !1)
        }
        return function(o) {
            var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {};
            switch (f = t.duration || 1e3, r = t.offset || 0, l = t.callback, u = t.easing || v, d = t.a11y || !1, n = window.scrollY || window.pageYOffset, void 0 === o ? "undefined" : b(o)) {
                case "number":
                    e = void 0, d = !1, i = n + o;
                    break;
                case "object":
